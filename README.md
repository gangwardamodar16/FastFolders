...
Right-button Drag & Drop: If you drag and drop an object on a folder or drive using the right mouse button, you can copy or move the 
object(s) to any folder of your computer by selecting it from the FastFolders menu
...
Pressing “C” on an item will copy a list of contents of this item to the clipboard (like a directory listing). “SHIFT+C” includes the 
...
**What’s New in FastFolders 5 Full Version?**
...
**How to Crack or Activate DeskSoft FastFolders Cracked??**
